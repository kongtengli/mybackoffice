...
<html>
    ...
    <head>
        ...
        <link href="/tp/Public/assets/DT_bootstrap.css" rel="stylesheet" media="screen">
    ...
    <body>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <table class="table">
						              ...
						              <tbody>
                                                              <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="<?php if($v["type"] == 1): ?>success<?php endif; ?>">
						                  <td><?php echo ($v["id"]); ?></td>
        ...
        <script src="/tp/Public/vendors/jquery-1.9.1.js"></script>
        <script src="/tp/Public/bootstrap/js/bootstrap.min.js"></script>
        <script src="/tp/Public/vendors/datatables/js/jquery.dataTables.min.js"></script>


        <script src="/tp/Public/assets/scripts.js"></script>
        <script src="/tp/Public/assets/DT_bootstrap.js"></script>
        <script>
        $(function() {
